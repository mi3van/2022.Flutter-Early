...
class _UnitConverterState extends State<UnitConverter> {
  ...
  void _updateConversion() async {
    final double newConvertedDouble;
    if (widget.category.name != apiCategory['name']) {
      newConvertedDouble =
          _inputValue! * (_toValue!.conversion! / _fromValue!.conversion!);
    } else {
      final api = Api();
      newConvertedDouble = await api.convert(apiCategory['route']!,
              _fromValue!.name!, _toValue!.name!, _inputValue.toString()) ??
          0.0;
    }
    setState(() {
      _convertedValue = _format(newConvertedDouble);
    });
  }
